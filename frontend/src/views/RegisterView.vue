      ...
      <b-col cols="10" lg="5" md="7">
        ...
        <b-card-group deck>
          <b-card border-variant="success" header-bg-variant="success">
            <template #header>
              <h6 class="text-white text-center">Register</h6>
            </template>
            <b-card-text>
              <b-form @submit.prevent="onSubmit">
                ...
                <label for="" class="mb-2 mt-3 lable">ชื่อ</label>
                <b-form-input id="u_firstname" v-model.trim="form.u_firstname" type="text" placeholder="" required>
                </b-form-input>
                <label for="" class="mb-2 mt-3 lable">นามสกุล</label>
                <b-form-input id="u_lastname" v-model.trim="form.u_lastname" type="text" placeholder="" required>
                </b-form-input>


                <b-row class="mb-2 mt-4">
                  <b-col>
                    <b-button squared type="submit" variant="success">ลงทะเบียน
                    </b-button>
                  </b-col>
                </b-row>
                ...
                <b-row>
                  <b-col>
                    <b-button squared @click="onRedirect()" variant="primary">เข้าสู่ระบบ</b-button>
                  </b-col>
                </b-row>
              </b-form>
            </b-card-text>
    ...
    onSubmit() {
      ...
      axios
        ...
        .catch(error => {
          ...
          // const text_er = error.response.data.error.validation.errors
          // const obj_error =[];
          // for (let k in text_er){
          //    obj_error.push(text_er[k].msg)
